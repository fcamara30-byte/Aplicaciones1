...
for i in range(200):
    ...
    # 🔴 PRESIÓN EXACTA DEL EXCEL (TODO EN PSI, como Python)
    P_hid = rho_int * z_int / 144
    Pi = P_iny + P_hid
    Po = 0   # Excel NO usa presión externa en hoop

    # =========================================
    # AXIAL (EXCEL: PESO PURO)
    # =========================================
    A = np.pi/4 * (OD**2 - ID**2)
    F_weight = peso * z
    ax_val = F_weight / A   # psi
    ...
    # 🔴 RECIÉN ACÁ PASAMOS A KSI (igual Excel)
