...
tubos = {
    ...
    '5 1/2" #17': (5.500, 4.892, 17),
    '7" #23': (7.000, 6.360, 23.0),
    '7" #32': (7.000, 6.094, 32.0),
...
if torque_max_rosca is not None:
    ...
    ax.text(
        -SMYS * 0.95,        # 👈 POSICIÓN A LA IZQUIERDA (ajustable)
        SMYS * 0.7,        # altura
        msg,
        fontsize=9,
        color=color_txt,
        ha="left",          # 👈 importante para que el cuadro crezca bien
        bbox=dict(
            facecolor="white",
            edgecolor=color_txt,
